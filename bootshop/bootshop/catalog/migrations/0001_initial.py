# Generated by Django 3.1.7 on 2021-07-06 20:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Unique value for product URL, created from name', max_length=255, unique=True)),
                ...
                ('description', models.TextField()),
                ('meta_keywords', models.CharField(help_text='Comma-delimited set of SEO for keyword meta tag', max_length=255)),
